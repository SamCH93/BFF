...
\caption{Multiple logistic regression BFF analysis of 2992 births with 17
  ...
  indicators, except early age (0, 20 ,1 15 19, 2 under 15), gestational age
  ($0 = \text{no}$, $1 = 36-38$ weeks, $2 = 33-36$ weeks; under 33 weeks
  excluded), isoimmunization ($0 = \text{no}$, $1 = \text{Rh}$,
