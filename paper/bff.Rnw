...
\author{
  ...
  {\color{blue} Preprint version January 20, 2025}
}
\date{}
...
contradictory conclusions with the Bayes factor \citep[for examples,
  see][]{Stone1997, Wagenmakers2020}, or they can assign prior probabilities to
the tested hypotheses and report a posterior averaged over both hypotheses
\citep[known as Bayesian model averaging, see
